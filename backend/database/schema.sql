-- ============================================
-- BuyIt Marketplace - Full PostgreSQL Schema
-- ============================================
...
(8, 'Philips', 'Consumer electronics', 'ACTIVE'),
(9, 'Lakme', 'Beauty and cosmetics', 'ACTIVE'),
(10, 'Penguin Books', 'Publishing house', 'ACTIVE')
ON CONFLICT (id) DO NOTHING;

ALTER SEQUENCE brands_id_seq RESTART WITH 11;
...
ALTER SEQUENCE cart_id_seq RESTART WITH 4;
