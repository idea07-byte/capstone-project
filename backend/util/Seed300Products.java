 ...
 * Seed300Products
 *
 * Seeds exactly 300 realistic, high-quality products across all 15 categories
 * (20 products per category) with authentic titles, detailed descriptions,
 * accurate prices, stock counts, SKU codes, and crystal-clear Unsplash HD photo URLs.
 */
public class Seed300Products {
    ...
    public static List<ProductItem> get300Products() {
        ...
        list.add(new ProductItem(2, 5, 3, "Zara Oversized Trench Coat (Beige)",
            ...
            "https://images.unsplash.com/photo-1544923246-77307dd654cb?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(2, 5, 4, "Polo Ralph Lauren Classic Fit Polo Shirt",
            ...
            "https://images.unsplash.com/photo-1586363104862-3a5e2ab60d99?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(2, 5, 3, "Nike Dri-FIT Flex Stride Running Shorts 7-inch",
            ...
            "https://images.unsplash.com/photo-1591195853828-11db59a44f6b?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(2, 5, 4, "Hugo Boss Slim-Fit Cotton Chino Trousers",
            ...
            "https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(2, 5, 4, "Massimo Dutti 100% Cashmere Crew Sweater",
            ...
            "https://images.unsplash.com/photo-1576871337632-b9aef4c17ab9?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(3, 9, 5, "Prestige Iris 750W Mixer Grinder (3 Jars)",
            ...
            "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(3, 9, 5, "Prestige Induction Cooktop PIC 20.0 (1200W)",
            ...
            "https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(3, 9, 5, "Le Creuset Enameled Cast Iron Dutch Oven (5.5 Qt)",
            ...
            "https://images.unsplash.com/photo-1584992236310-6edddc08acff?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(3, 9, 5, "Wusthof Classic 8-Inch Chef's Knife (Solingen)",
            ...
            "https://images.unsplash.com/photo-1593618998160-e34014e67546?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(3, 9, 5, "Prestige Stainless Steel Vacuum Flask 1000ml",
            ...
            "https://images.unsplash.com/photo-1602143407151-7111542de6e8?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(4, 11, 10, "Clean Code: A Handbook of Agile Software Craftsmanship",
            ...
            "https://images.unsplash.com/photo-1532012164546-f432f2e3edd7?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(4, 12, 8, "Catan Board Game (5th Edition)",
            ...
            "https://images.unsplash.com/photo-1610890716171-6b1bb98ffd09?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(4, 12, 8, "Handcrafted Staunton Wooden Chess Set with Storage Board",
            ...
            "https://images.unsplash.com/photo-1529699211952-734e80c4d42b?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(4, 12, 8, "Sphero BOLT App-Enabled Programmable Robot Ball",
            ...
            "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(5, 13, 3, "Nike Strike Team Match Football (Size 5)",
            ...
            "https://images.unsplash.com/photo-1614632537423-1e6c2e7e0aab?w=800&auto=format&fit=crop&q=85",
            "https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(5, 13, 4, "Yonex Astrox 99 Pro Carbon Badminton Racket",
            ...
            "https://images.unsplash.com/photo-1626224583764-f87db24ac4ea?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(5, 13, 3, "Wilson Pro Staff 97 v14 Tennis Racket",
            ...
            "https://images.unsplash.com/photo-1622279457486-62dcc4a431d6?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(5, 13, 3, "Nike Fundamental Heavy Resistance Band Set (5-Pcs)",
            ...
            "https://images.unsplash.com/photo-1598289431512-b97b0917affc?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(5, 13, 4, "Speedo Fastskin Hyper Elite Swimming Goggles",
            ...
            "https://images.unsplash.com/photo-1530549387789-4c1017266635?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(3, 14, 5, "Blue Tokai Single Origin Vienna Roast Whole Beans (500g)",
            ...
            "https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=800&auto=format&fit=crop&q=85",
            "https://images.unsplash.com/photo-1587734195503-904fca47e0e9?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(3, 14, 5, "Barilla Collezione Penne Rigate Bronze Cut Pasta (500g)",
            ...
            "https://images.unsplash.com/photo-1551462147-ff29053bfc14?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(3, 14, 5, "Maldon Sea Salt Flakes (240g Box)",
            ...
            "https://images.unsplash.com/photo-1518843875459-f738682238a6?w=800&auto=format&fit=crop&q=85"));
        ...
        list.add(new ProductItem(3, 14, 5, "San Pellegrino Sparkling Natural Mineral Water (Pack of 6 x 750ml)",
            ...
            "https://images.unsplash.com/photo-1559839914-ba2a0f8eb3d6?w=800&auto=format&fit=crop&q=85"));
        ...
        // ==========================================
        // 15. APPLIANCES (Cat 15) - 20 Products
        // ==========================================
    ...
    public static void main(String[] args) {
        ...
        try (Connection conn = Database.getConnection()) {
            ...
            try (Statement stmt = conn.createStatement()) {
                // Clear existing child dependencies safely
